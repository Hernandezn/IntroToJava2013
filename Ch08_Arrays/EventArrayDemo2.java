...
public class EventArrayDemo2{
	public static void main(String[]args){
		...
		for(x=0; x<someEvents.length; x++){
			strSelectedEvent=JOptionPane.showInputDialog(null,"Event #"+
				(x+1)+" Enter the number for the type of event you want:"+
				choicesString);
		...
		for(x=0; x<someEvents.length; x++)
			System.out.println(someEvents[x].getType()+" "+
				...
				someEvents[x].getRate()+" "+someEvents[x].getManager());
	}
}