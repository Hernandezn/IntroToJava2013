...
public class PigDiceGame{
	...
	public static boolean intro(){
		...
		JOptionPane.showMessageDialog(null,"You're going to be "+
			"playing a game of Pig against the computer.\nYou'll be"+
			" racing to get to 100 points.\nYou roll two dice, and "+
			"if you don't roll any 1s, the total gets added to your"+
			" score, and you can choose to either continue your turn"+
			" or to pass the turn to the computer.\nIf you DO roll a"+
			" 1, no points are added to your score, and your turn "+
			"ends.\nIf you roll two 1s, your score is reset to zero,"+
			" and your turn ends.\nIt's a game of chance, so I can't"+
			" really give any tips. Good luck!");
	...
	public static int playerTurn(int score,Die x,Die y){
		int roll1, roll2;
		boolean again;
		int selection;
		...
		do{
			...
			if(roll1!=1 && roll2!=1){
				...
				selection=JOptionPane.showConfirmDialog(null,"You "+
					...
					"your score to "+score+". Would you like to roll"+
					" again?","Good Roll",JOptionPane.YES_NO_OPTION,
	...
	public static int compTurn(int score,Die x,Die y){
		int roll1, roll2;
		boolean again;
		double selection;
			...
			if(roll1!=1 && roll2!=1){
				...
				if(selection>=.5){
					JOptionPane.showMessageDialog(null,"The "+
						...
						"increasing its score to "+score+". It has "+
