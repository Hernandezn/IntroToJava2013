...
public class CardWar2{
	...
	public static void main(String[]args){
		...
		if(card1val==card2val && card1suit.equalsIgnoreCase(card2suit)){
			if(card1suit=="Spades")
				card1suit="Diamonds";
		...
		System.out.println("\nYou've drawn the "+card1.getRank()+
			" of "+card1.getSuit()+", and the computer has drawn the "+
	...
	public static String setCardSuit(){
		...
		num=(int)(Math.random()*400)%SUITS+1;
